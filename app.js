...
const GrinchMusic = () => {
return <h1>
    "Blast this Christmas music! It's joyful and triumphant."</h1>;
}
...
// 4a
    const GrinchScedule = () => {
        return (
            <div>
                <ul>
                    <li>"4:00, wallow in self-pity."
</li>
                    <li>"4:30, stare into the abyss."
</li>
                    <li>"5:00, solve world hunger, tell no one."</li>
                    <li>"5:30, jazzercize."
</li>
                    <li>"6:30, dinner with me. I can't cancel that again."</li>
                    <li>"7:00, wrestle with my self-loathing."
</li>
                </ul>
...
// 5a
    const GrinchPoster = () => {
        return <img
        src = "https://img01.mgo-images.com/image/thumbnail/v2/content/1MV1ca3f097dd209568db5d4a36e"
    ...
    const GrinchVmail = () => {
        ...
        return (
            <div>
                <h1>"IF {u} YOU UTTER SO MUCH AS ONE SYLLABLE, I'LL HUNT {u} YOU DOWN AND GUT YOU LIKE A FISH!"</h1>
    ...
    const DiceRoll = () => {
        // 8b
        const diel = Math.floor(6 * Math.random()) + 1;
        // 8c
